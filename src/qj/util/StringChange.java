...
//				&& o instanceof InsertStringChange
	...
	public static String apply(Collection<StringChange> replaces, String text) {
		ArrayList<StringChange> list = new ArrayList<>(replaces);
	...
	public static LinkedList<StringChange> replaceAll(String replaceFrom, String replaceTo, String to) {
		LinkedList<StringChange> ret = new LinkedList<>();
