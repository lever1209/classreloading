...
//		resp.setCharacterEncoding("UTF-8");
		...
		resp.setContentType(uri.endsWith(".js") ? "application/javascript"
				: uri.endsWith(".css") ? "text/css"
						: uri.endsWith(".svg") ? "image/svg+xml"
								: uri.endsWith(".ttf") ? "application/octet-stream"
										: uri.endsWith(".woff") ? "font/woff" : null);
	...
	static class ContentFilterHolder {
		...
		public ContentFilterHolder(F1<String, Boolean> uriCheck, F1<String, String> contentFilter) {
